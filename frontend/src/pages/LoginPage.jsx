...
import { Loader, Lock, ArrowRight, Mail, LogIn } from 'lucide-react';
        ...
        <div className='bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10'>
              ...
              <div>
                ...
                <div className='mt-1 relative rounded-md shadow-sm'>
                  ...
                  <input
                    ...
                    className='block w-full pl-10 pr-3 py-2 border-gray-500 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-gray-700 text-gray-300'
          ...
          <div className='mt-6 text-center'>
            <p className='text-sm text-gray-400'>
              Not a member?{' '}
              <Link to='/signup' className='font-medium text-blue-400 hover:text-blue-600'>
