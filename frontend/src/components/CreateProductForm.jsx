    ...
    >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="mt-1 flex items-center">
                    ...
                    leading-4 font-medium text-gray-300 hover:bg-gray-600 focus:ontline-none focus:ring-2 focus:ring-offset-0
                    focus:ring-blue-500'>
                ...
                <button
                    ...
                    font-medium text-white bg-blue-400 hover:bg-blue-600 focus:outline-none focus:ring-2 
